...
public class RoyaleArenaTest {
    ...
    public void testChangeType() {
        ...
        Battlecard battlecard = new Battlecard(1, CardType.MELEE, "test_name", 100, 50);
        royaleArena.add(battlecard);
        royaleArena.changeCardType(1, CardType.BUILDING);

        assertEquals(CardType.BUILDING, battlecard.getType());
    }

    @Test(expected = IllegalArgumentException.class)
    public void testChangeTypeException() {
        RoyaleArena royaleArena = new RoyaleArena();
        Battlecard battlecard = new Battlecard(1, CardType.MELEE, "test_name", 100, 50);
        royaleArena.add(battlecard);
        royaleArena.changeCardType(2, CardType.BUILDING);
    }
    ...
    public void testSwag() {
        ...
        Battlecard battlecard = new Battlecard(1, CardType.MELEE, "test_name", 100, 50);
        royaleArena.add(battlecard);
        royaleArena.findFirstLeastSwag(1);
    }
